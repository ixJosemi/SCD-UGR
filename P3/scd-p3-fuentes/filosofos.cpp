...
void funcion_filosofos( int id)
{
  ...
  while (true)
  {
    ...
    if (id == 0)
    {
      ...
      cout << "Filosofo " << id << " coge tenedor der. " << id_ten_der << endl;
...
void funcion_tenedores( int id )
{
  ...
  while ( true )
  {
    ...
    MPI_Recv(&valor, 1, MPI_INT, id_filosofo, soltar, MPI_COMM_WORLD, &estado);
